...
class ChatTableViewCell: UITableViewCell {
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            label.bottomAnchor.constraint(equalTo: wrapperCellView.bottomAnchor),
            label.leadingAnchor.constraint(equalTo: wrapperCellView.leadingAnchor, constant: 18),
            label.trailingAnchor.constraint(equalTo: wrapperCellView.trailingAnchor, constant: -18),
